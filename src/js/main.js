...
$(window).on("scroll", function(){
  if($(this).scrollTop() > 100){
    $(".hero_fixed").css('background', '#222');
    $(".hero_reserve").css('background', '#222');
  } else{
    $(".hero_fixed").css('background', 'none');
    $(".hero_reserve").css('background', 'none');
  }
});


$(".burger").click(function(){
  $(".hero_nav").slideToggle("fast");
}
);

$(window).resize(function() {
  if ($(window).outerWidth() > 960)
  $(".hero_nav").css("display", "flex");
  else {
    $(".hero_nav").css("display", "block");
  }
});


$('header').parallax({imageSrc: 'img/blog-cvr-9-26.jpg'});
